...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            profiles::preview_library_version_cleanup,
            profiles::preview_library_mod_version_removal,
            profiles::remove_library_mod_version,
            profiles::execute_library_version_cleanup,
            profiles::remove_library_mod_version_manual,
