...
export function BrowseView({ onGoToSettings }: BrowseViewProps = {}) {
  ...
  async function openNexusMod(modId: number) {
    ...
    try {
      ...
      toast.error(t('browse.nexus.openFailed', { error: e instanceof Error ? e.message : String(e) }));
    }
  }
        ...
        <>
          {nexusKeyMissing ? (
            ...
            <div className="gf-empty">
              ...
              <div className="gf-empty-title">{t('browse.nexus.loading', { type: tab === 'nexus_trending' ? t('browse.nexus.loadingTrending') : t('browse.nexus.loadingLatest') })}</div>
            </div>
          ) : nexusError ? (
            <div className="gf-empty">
